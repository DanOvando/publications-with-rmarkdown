...
I have mine set as lowercase first author last name followed by date, with letters for conflicts (e.g. `[@seal2020a;@seal2020b]` since that annoying seal published like crazy) 
...
`r ''````{r main-fig, fig.cap = "Our Main Results"}
plot(1:10)
```
````
...
OK, you now have a .Rmd file that will automatically update your results 
...
The mean penguin weighs `r mean(penguins$body_mass_g, na.rm = TRUE) / 1000 * 2.204623` pounds
...
GitHub: [DanOvando](www.github.com/danovando)

twitter: @danovand0

website: [www.danovando.com](http://www.danovando.com)
